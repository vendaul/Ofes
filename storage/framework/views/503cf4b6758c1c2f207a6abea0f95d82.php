...
<div class="page-header d-flex justify-content-between align-items-start">
    <div>
        ...
        <p>Welcome back, <?php echo e($instructor->fname); ?> <?php echo e($instructor->lname); ?>!</p>
    </div>
    <div class="text-end">
        <div class="badge bg-info text-dark py-2 px-3">
            <strong>Active Period:</strong><br>
            <?php echo e($activePeriod ? $activePeriod->year . ' / ' . $activePeriod->term : 'N/A'); ?>
    ...
    <div class="col-md-6 mb-4">
        <div class="card h-100">
            <div class="card-body text-center">
                ...
                <a href="<?php echo e(route('instructor.workload')); ?>" class="btn btn-primary btn-lg">
    ...
    <div class="col-md-6 mb-4">
        <div class="card h-100">
            <div class="card-body text-center">
                ...
                <a href="<?php echo e(route('instructor.reports')); ?>" class="btn btn-success btn-lg">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row text-center">
                    ...
                    <div class="col-md-4">
                        <h3 class="text-success"><?php echo e($workloadCount); ?></h3>
                    ...
                    <div class="col-md-4">
                        <h3 class="text-info">
                            ...
                            ?>
                            <?php echo e($scaledRating !== null ? $scaledRating : 'N/A'); ?>
...
<?php echo $__env->make('layouts.faculty', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/April2Ofes copy/resources/views/instructor/dashboard.blade.php ENDPATH**/ ?>