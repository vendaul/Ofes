...
<head>
    ...
    <title><?php echo e(config('app.name', 'OFES')); ?> - Faculty Panel</title>
    <!-- Fonts -->
    ...
    <div class="sidebar">
        ...
        <ul class="nav flex-column">
            <li class="nav-item mb-2">
                <a href="<?php echo e(route('instructor.dashboard')); ?>" class="nav-link text-white">
                    <i class="fas fa-home"></i> Dashboard
                </a>
            </li>
            <li class="nav-item mb-2">
                <a href="<?php echo e(route('instructor.workload')); ?>" class="nav-link text-white">
                    <i class="fas fa-tasks"></i> My Workload
                </a>
            </li>
            <li class="nav-item mb-2">
                <a href="<?php echo e(route('instructor.reports')); ?>" class="nav-link text-white">
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/April2Ofes copy/resources/views/layouts/faculty.blade.php ENDPATH**/ ?>