                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <?php else: ?>
                                        <button type="submit" form="viewTemplateForm<?php echo e($template->id); ?>" class="btn btn-warning view-template-save-btn">Save</button>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="modal-dialog modal-lg">
                                <form id="editTemplateForm<?php echo e($template->id); ?>" action="<?php echo e(route('question_templates.update', $template)); ?>" method="POST">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                                            <button type="submit" form="editTemplateForm<?php echo e($template->id); ?>" class="btn btn-success">Save Changes</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/April2Ofes copy/resources/views/questions/index.blade.php ENDPATH**/ ?>