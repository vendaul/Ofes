...
<table class="info-table">
    ...
    <tr>
        ...
        <td>: <?php echo e($instructor->department ?: optional($instructor->collegeRelation)->name ?: 'N/A'); ?></td>
    </tr>
    <tr>
        <td class="info-label">Current Faculty Rank</td>
        <td>: <?php echo e($instructor->academic_rank ?? $instructor->position ?? 'N/A'); ?></td>
    </tr>
    <tr>
        <td class="info-label">Semester/Term & Academic Year</td>
        <td>: <?php echo e($semester ?? 'N/A'); ?></td>
    </tr>
</table>
...
<table class="report">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><?php echo e($class->course_code); ?></td>
            <td><?php echo e($class->section); ?></td>
            <td><?php echo e($class->students); ?></td>
            <td><?php echo e($class->average); ?></td>
            <td><?php echo e(number_format($weighted, 0)); ?></td>
        </tr>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

        <tr class="total-row">
            <td colspan="3">TOTAL</td>
            <td><?php echo e($totalStudents); ?></td>
            <td colspan="1">TOTAL</td>
            <td><?php echo e(number_format($totalWeighted, 0)); ?></td>
        </tr>
    </tbody>
</table>
...
<?php echo $__env->make('layouts.faculty', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/April2Ofes copy/resources/views/instructor/reports.blade.php ENDPATH**/ ?>