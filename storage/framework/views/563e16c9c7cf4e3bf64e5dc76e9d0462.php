...
<?php if(!($selectedArea ?? session('selected_area')) || !($selectedCollege ?? session('selected_college'))): ?>
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('subjects.store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <input type="hidden" name="tab" value="<?php echo e($activeTab ?? request('tab', 'subjects')); ?>">

                        <div class="row g-2 mb-3">
                            <div class="col-md-6">
                                <label for="area_code" class="form-label">Area</label>
                                <select id="area_code" name="area_code" class="form-select <?php $__errorArgs = ['area_code'];
...
unset($__errorArgs, $__bag); ?>" required>
                                    ...
                                    <option value="<?php echo e($areaCode); ?>" <?php echo e((string) old('area_code', $selectedArea ?? session('selected_area')) === (string) $areaCode ? 'selected' : ''); ?>><?php echo e($areaName); ?></option>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6">
                                ...
                                <select id="college_id" name="college_id" class="form-select <?php $__errorArgs = ['college_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" required>
                                    ...
                                    <option value="<?php echo e($college->id); ?>" data-area-code="<?php echo e($college->area_code); ?>" <?php echo e((string) old('college_id', $selectedCollege ?? session('selected_college')) === (string) $college->id ? 'selected' : ''); ?>><?php echo e($college->name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                        ...
                        <div class="row g-2">
                            <div class="col-md-8">
                                ...
                                <div class="input-group mb-2">
                                    ...
                                    <input type="text" id="program_combo" class="form-control" placeholder="Search or type program" autocomplete="off" list="program_datalist" value="<?php echo e($defaultProgramQuery); ?>">
                                </div>
                                <input type="hidden" id="program_id" name="program_id" value="<?php echo e($defaultProgramId); ?>">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control <?php $__errorArgs = ['new_program_code'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="new_program_code_modal" name="new_program_code" placeholder="Program code" value="<?php echo e(old('new_program_code')); ?>">
                                            <?php $__errorArgs = ['new_program_code'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><div class="invalid-feedback"><?php echo e($message); ?></div><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control <?php $__errorArgs = ['new_program_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="new_program_name_modal" name="new_program_name" placeholder="Program description " value="<?php echo e(old('new_program_name')); ?>">
                                            <?php $__errorArgs = ['new_program_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><div class="invalid-feedback"><?php echo e($message); ?></div><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row g-2 mt-3">
                            <div class="col-md-8">
                                ...
                                <div class="input-group mb-2">
                                    <span class="input-group-text"><i class="fas fa-search"></i></span>
                                    <input type="text" id="curriculum_combo" class="form-control" placeholder="Search or type curriculum" autocomplete="off" list="curriculum_datalist" value="<?php echo e($defaultCurriculumQuery); ?>">
                                </div>
                                <input type="hidden" id="curriculum_id" name="curriculum_id" value="<?php echo e($defaultCurriculumId); ?>">
                                <datalist id="curriculum_datalist">
                                    ...
                                    <option value="<?php echo e($curriculum->code); ?> - <?php echo e($curriculum->desc); ?><?php if($curriculum->course): ?> (<?php echo e($curriculum->course->course_program); ?>)<?php endif; ?>" data-id="<?php echo e($curriculum->id); ?>" data-course-id="<?php echo e($curriculum->course_id); ?>"></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </datalist>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row g-2 mt-2 d-none" id="new-curriculum-row">
                            <div class="col-md-6">
                                <input type="text" class="form-control <?php $__errorArgs = ['new_curriculum_code'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="new_curriculum_code_modal" name="new_curriculum_code" placeholder="Curriculum code" value="<?php echo e(old('new_curriculum_code')); ?>">
                                <?php $__errorArgs = ['new_curriculum_code'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><div class="invalid-feedback"><?php echo e($message); ?></div><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control <?php $__errorArgs = ['new_curriculum_desc'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="new_curriculum_desc_modal" name="new_curriculum_desc" placeholder="Description" value="<?php echo e(old('new_curriculum_desc')); ?>">
                                <?php $__errorArgs = ['new_curriculum_desc'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><div class="invalid-feedback"><?php echo e($message); ?></div><?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="code" name="code" placeholder="e.g., CS101, MATH201" required>
...
unset($__errorArgs, $__bag); ?>" id="name" name="name" placeholder="e.g., Introduction to Computer Science" required>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select class="form-select <?php $__errorArgs = ['subject_year'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="subject_year" name="subject_year">
                                    <option value="" disabled <?php echo e(old('subject_year') ? '' : 'selected'); ?>>Select year</option>
                                    <option value="First" <?php echo e(old('subject_year') == 'First' ? 'selected' : ''); ?>>First</option>
                                    <option value="Second" <?php echo e(old('subject_year') == 'Second' ? 'selected' : ''); ?>>Second</option>
                                    <option value="Third" <?php echo e(old('subject_year') == 'Third' ? 'selected' : ''); ?>>Third</option>
                                    <option value="Fourth" <?php echo e(old('subject_year') == 'Fourth' ? 'selected' : ''); ?>>Fourth</option>
                                </select>
                                <?php $__errorArgs = ['subject_year'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select class="form-select <?php $__errorArgs = ['subject_term'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="subject_term" name="subject_term">
                                    <option value="" disabled <?php echo e(old('subject_term') ? '' : 'selected'); ?>>Select term</option>
                                    <option value="First" <?php echo e(old('subject_term') == 'First' ? 'selected' : ''); ?>>First</option>
                                    <option value="Second" <?php echo e(old('subject_term') == 'Second' ? 'selected' : ''); ?>>Second</option>
                                    <option value="Third" <?php echo e(old('subject_term') == 'Third' ? 'selected' : ''); ?>>Third</option>
                                </select>
                                <?php $__errorArgs = ['subject_term'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <a href="<?php echo e(route('subjects.index', ['tab' => $activeTab ?? request('tab', 'subjects')])); ?>#<?php echo e($activeTab ?? request('tab', 'subjects')); ?>" class="btn btn-secondary">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (saveNewProgram) {
            saveNewProgram.addEventListener('click', function() {
                ...
                fetch('<?php echo e(route("programs.ajaxCreate")); ?>', {
                    method: 'POST'
                    , headers: {
        ...
        if (saveNewCurriculum) {
            saveNewCurriculum.addEventListener('click', function() {
                ...
                fetch('<?php echo e(route("curriculums.ajaxCreate")); ?>', {
                    method: 'POST'
                    , headers: {
                        'Content-Type': 'application/json'
                        , 'X-CSRF-TOKEN': token
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/April2Ofes copy/resources/views/subjects/create.blade.php ENDPATH**/ ?>