        ...
        <div class="col-md-4">
            <div class="card shadow">
                <div class="card-body text-center">
                    ...
                    <h4>{{ $nameValue }}</h4>
                    <p class="text-muted">{{ $emailValue !== '' ? $emailValue : 'No email' }}</p>

                    <hr>

                    <p><strong>Role:</strong> {{ Auth::user()->display_role }}</p>
    ...
    <div class="card shadow">
        ...
        <div class="card-body">
            ...
            <div class="mb-3">
                ...
                <p>{{ Auth::user()->last_login_at ? Auth::user()->last_login_at->format('M d, Y H:i') : 'Not available' }}</p>
            </div>
