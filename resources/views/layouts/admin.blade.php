...
<head>
    ...
    <title>{{ config('app.name', 'OFES') }} - Admin Panel</title>
    <!-- Fonts -->
...
<body>
    <div class="sidebar">
        ...
        <ul class="sidebar-nav">
            ...
            <li class="nav-item">
                <a href="{{ route('admin.area_college') }}" class="nav-link {{ request()->routeIs('admin.area_college') ? 'active' : '' }}">
            ...
            <li class="nav-item">
                <a href="{{ route('sections.index') }}" class="nav-link sub-link {{ request()->routeIs('sections.*') ? 'active' : '' }}">
                ...
                <div class="ms-auto d-flex align-items-center" style="gap:.75rem;">
                    ...
                    <div class="dropdown">
                        ...
                        <div id="myDropdown" class="dropdown-content custom-dropdown">
                            ...
                            <a href="{{ route('settings.myAccount') }}">
                                <i class="fas fa-user-cog text-success"></i>
                                <span>Manage My Account</span>
                            </a>

                            <a href="{{ route('settings.semester') }}">
                            ...
                            <a href="{{ route('logout') }}" class="logout-link text-danger">
                                <i class="fas fa-sign-out-alt"></i>
                                <span>Logout</span>
                            </a>
                        </div>
