...
<body>
    <div class="role-container">
        ...
        <div class="role-buttons">
            <a href="{{ route('student.login') }}" class="role-btn role-btn-student">
                <i class="fas fa-user-graduate"></i>
                <span>Student</span>
            </a>
            <a href="{{ route('instructor.login') }}" class="role-btn role-btn-instructor">
                <i class="fas fa-chalkboard-user"></i>
                <span>Instructor</span>
            </a>
            <a href="{{ route('admin.login') }}" class="role-btn role-btn-admin">
